  ...
  try {
    $.each(response, function(i, item) {
      ...
      if(item['fn'] == '.'){ //|| item['fn'] == '..'
        ...
        var strBtnR = '<button title="Rename" type="button" class="btn btn-warning '+isHide+' " name="button" onclick="rename('+"'"+item['fn']+"'"+','+"'"+OrigName[i][0]+"'"+')"><i class="fa fa-edit"></i></button> ';
        ...
        if(isImage(parts))
        {
          var $tr = $('<tr>').append(
              ...
              $('<td>').html('<a href="Myshelf/viewimg/'+ strPath+'/' + item['fn'] + '" target="_blank"><i class="fa fa-file-image-o fa-fw"></i> '+ OrigName[i][0].split(".")[0]+'</a><br>  <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
          ...
          var $tr = $('<tr>').append(
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '" target="_blank"><i class="fa fa-file-excel-o fa-fw"></i> '+ OrigName[i][0].split(".")[0]+'</a><br> <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '"><i class="fa fa-download fa-fw"></i></a>'),
              $('<td>').text(OrigName[i][1]),
              $('<td>').text('Excel, '+ parts),
              $('<td class="center">').text((item['fz']/1000000).toFixed(2)+" "+" mb"),
          ...
          var $tr = $('<tr>').append(
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '" target="_blank"><i class="fa fa-file-powerpoint-o fa-fw"></i> '+ OrigName[i][0].split(".")[0]+'</a><br> <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '"><i class="fa fa-download fa-fw"></i></a>'),
              $('<td>').text(OrigName[i][1]),
          ...
          var $tr = $('<tr>').append(
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '" target="_blank"><i class="fa fa-file-archive-o fa-fw"></i> '+ OrigName[i][0].split(".")[0]+'</a><br> <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '"><i class="fa fa-download fa-fw"></i></a>'),
              $('<td>').text(OrigName[i][1]),
          ...
          var $tr = $('<tr>').append(
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '" target="_blank"><i class="fa fa-file-text-o fa-fw"></i>'+ OrigName[i][0].split(".")[0]+'</a><br> <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '"><i class="fa fa-download fa-fw"></i></a>'),
              $('<td>').text(OrigName[i][1]),
              $('<td>').text('Text, '+ parts),
              $('<td class="center">').text((item['fz']/1000000).toFixed(2)+" "+" mb"),
          ...
          var $tr = $('<tr>').append(
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '" target="_blank"><i class="fa fa-file-pdf-o fa-fw"></i> '+ OrigName[i][0].split(".")[0]+'</abbr></a><br> <p style="margin:0px;font-size:12px;">'+(OrigName[i][2] !== null ? OrigName[i][2]:'')+'</p>'),
              $('<td>').html('<a href="Myshelf/download/'+strPath  +'/'+ item['fn'] + '"><i class="fa fa-download fa-fw"></i></a>'),
              $('<td>').text(OrigName[i][1]),
